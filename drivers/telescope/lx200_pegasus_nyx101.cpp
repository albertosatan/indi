...
bool LX200NYX101::initProperties()
{
    ...
    //setGuideRate(guideRate); // :-) ADDED TO ASSURE CORRECT GUIDE RATE (aperez@disca.upv.es)
...
bool LX200NYX101::updateProperties()
{
	...
	defineProperty(&ParkOptionSP); // :-) (aperez@disca.upv.es)
    }
    else
    {
	...
	deleteProperty(ParkOptionSP.name); // :-) (aperez@disca.upv.es)
    }
